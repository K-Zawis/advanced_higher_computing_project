...
class DesktopAssignmentMode extends ConsumerStatefulWidget {
...
class _DesktopAssignmentModeState extends ConsumerState<DesktopAssignmentMode> with TickerProviderStateMixin {
  var tempMap = {};
  ...
  initTts(WidgetRef ref) {
    ...
    _flutterTts.setLanguage(ref.read(languageProvider).items[ref.read(languageProvider).getLanguage()]!.ISOcode);
                                      ...
                                      children: [
                                        ...
                                        FloatingActionButton(
                                          onPressed: () {
                                            ...
                                            tempMap.putIfAbsent('date', () => DateTime.now());
                                            print(tempMap);
                                          },
                                        ),
                                      ],
